    ...
    return (
      <section className="w-full max-w-full flex-start flex-col">
        ...
        <p className="desc text-left max-w-md">
          {type} and share amazing prompts with the world, Harness the power of your words. Create prompts that unlock the full potential of AI and redefine the way we interact with technology.
        </p>
